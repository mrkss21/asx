...
echo ""
echo ""
echo "####Just wait for 15 confirms, make sure that wallet sync and block is like in explorer. Use this command to check:####"
echo ""
echo "arktur-cli getinfo | grep blocks"
echo ""
echo "####Start node on wallet and check status with this command:####"
echo ""
